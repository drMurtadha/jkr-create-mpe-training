...
const home = shell({
  ...
  <main id="kandungan">
    ...
    <section class="section"><div class="container"><div class="section-head"><div><p class="eyebrow">Laluan pembelajaran</p><h2>Lima modul, satu perjalanan transformasi</h2></div><p>Cadangan yang dibina dalam Modul 1 menjadi konteks amali untuk automasi dokumen, analisis rekod, aliran kerja dan penyediaan bahan projek.</p></div><div class="grid module-grid">${[
      ['1','Pengenalan aplikasi pintar','90 minit','modul-1/index.html','ready'],['2','AI generatif untuk dokumen rasmi','120 minit','modul-2/index.html','ready'],['3','Analisis data dan rekod teknikal','210 minit','modul-3/index.html','ready'],['4','Automasi aliran kerja makmal','120 minit','modul-4/index.html','ready'],['5','Siapkan dan sesuaikan MPE Hub','120 minit','modul-5/index.html','ready']
...
await markdownPage({ source: 'Modul 5/README.md', output: 'modul-5/index.html', title: 'Modul 5 — Siapkan dan Sesuaikan MPE Hub', description: moduleFiveIntro, moduleNumber: 5, slideButton: true });
