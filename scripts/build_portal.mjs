...
async function markdownPage({ source, output, title, description, prefix = '../', moduleNumber = 1, downloads = false, slideButton = false, hiddenSections = [] }) {
  ...
  const moduleFiveAside = `<aside class="article-nav"><strong>Dalam Modul 5</strong><a href="index.html">Ringkasan modul</a><a href="slaid.html">Slaid web</a><a href="kandungan-slaid.html">Kandungan slaid (cetak)</a><a href="nota-fasilitator.html">Nota fasilitator</a><a href="kit-binaan.html">Kit binaan & prompt</a><a href="latihan.html">Latihan MPE Hub</a><a href="penilaian.html">Penilaian akhir</a><strong style="margin-top:1rem">Pada halaman ini</strong><div data-article-nav></div></aside>`;
...
const home = shell({
  ...
  <main id="kandungan">
    ...
    <section class="section"><div class="container"><div class="section-head"><div><p class="eyebrow">Laluan pembelajaran</p><h2>Lima modul, satu perjalanan transformasi</h2></div><p>Cadangan yang dibina dalam Modul 1 menjadi konteks amali untuk automasi dokumen, analisis rekod, aliran kerja dan penyediaan bahan projek.</p></div><div class="grid module-grid">${[
      ['1','Pengenalan aplikasi pintar','90 minit','modul-1/index.html','ready'],['2','AI generatif untuk dokumen rasmi','120 minit','modul-2/index.html','ready'],['3','Analisis data dan rekod teknikal','210 minit','modul-3/index.html','ready'],['4','Automasi aliran kerja makmal','120 minit','modul-4/index.html','ready'],['5','Bina MPE Hub','120 minit','modul-5/index.html','ready']
...
const moduleFiveIntro = `Sesi integrasi hands-on untuk membina prototaip MPE Hub menggunakan AI generatif percuma, Google Sheets, Google Docs dan Google Apps Script.`;
await markdownPage({ source: 'Modul 5/README.md', output: 'modul-5/index.html', title: 'Modul 5 — Bina MPE Hub', description: moduleFiveIntro, moduleNumber: 5, slideButton: true });
...
await markdownPage({ source: 'Modul 5/03-Kit-Binaan-dan-Pustaka-Prompt.md', output: 'modul-5/kit-binaan.html', title: 'Kit Binaan dan Pustaka Prompt', description: 'Kod, struktur data dan prompt yang boleh disalin untuk membina MPE Hub.', moduleNumber: 5 });
await markdownPage({ source: 'Modul 5/04-Latihan-Bina-MPE-Hub.md', output: 'modul-5/latihan.html', title: 'Latihan Hands-on Bina MPE Hub', description: 'Arahan langkah demi langkah daripada Google Sheet kepada Web App dan Google Doc.', moduleNumber: 5 });
