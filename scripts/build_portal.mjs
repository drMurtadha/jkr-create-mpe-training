...
function rewriteModuleLinks(markdown, moduleNav) {
  if (!moduleNav) return markdown;
...
const home = shell({
  ...
  <main id="kandungan">
    ...
    <section class="section"><div class="container"><div class="section-head"><div><p class="eyebrow">Laluan pembelajaran</p><h2>Lima modul, satu perjalanan transformasi</h2></div><p>Cadangan yang dibina dalam Modul 1 menjadi konteks amali untuk automasi dokumen, analisis rekod, aliran kerja dan penyediaan bahan projek.</p></div><div class="grid module-grid">${[
      ['1','Pengenalan aplikasi pintar','90 minit','modul-1/index.html','ready'],['2','Automasi dokumen rasmi','120 minit','modul-2/index.html',''],['3','Analisis data dan rekod teknikal','210 minit','modul-3/index.html',''],['4','Automasi aliran kerja makmal','120 minit','modul-4/index.html',''],['5','Dokumen projek dan pembentangan','120 minit','modul-5/index.html','']
...
for (const number of [2, 3, 4, 5]) {
  ...
  await markdownPage({ source: `Modul ${number}/README.md`, output: `modul-${number}/index.html`, title: `Modul ${number} — ${moduleTitles[number]}`, description: `Ruang pembangunan kandungan Modul ${number}. Struktur portal telah tersedia untuk penambahan bahan seterusnya.`, moduleNav: false });
}
